  ...
  return <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto space-y-8 px-4">
        <div className="space-y-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold animate-fade-in leading-relaxed py-4 overflow-visible">
            <span className="inline-block">🥔</span>
            <span className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">potato groups</span>
            <span className="inline-block">🥔</span>
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground animate-fade-in">create perfect seating arrangements with student preferences</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 max-w-3xl mx-auto">
          <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-[var(--shadow-glow)] border-2 border-primary/20 hover:border-primary/40 transition-all hover:scale-105">
            ...
            <Button variant="playful" size="lg" className="w-full" onClick={() => navigate("/teacher/auth")}>
              Teacher Login
            </Button>
          </div>
          ...
          <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-[var(--shadow-glow)] border-2 border-secondary/20 hover:border-secondary/40 transition-all hover:scale-105">
            ...
            <Button variant="playful" size="lg" className="w-full" onClick={() => navigate("/student/login")}>
              Student Login
            </Button>
          </div>
        </div>
